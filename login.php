      ...
      <div class="row">
        <div class="col-sm-6 text-black">
          ...
          <div class="px-5 ms-xl-4">
            ...
            <span class="h1 fw-bold mb-0">Your Advantage Market</span>
          </div>
          ...
          <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            ...
            <form style="width: 23rem;" action="login.php" method="POST">
              ...
              <div class="form-outline mb-4">
                <input type="email" id="form2Example18" name="email" class="form-control form-control-lg" value="<?php echo htmlspecialchars($email); ?>" required />
                <label class="form-label" for="form2Example18">Email address</label>
              </div>

              <div class="form-outline mb-4">
                <input type="password" id="form2Example28" name="password" class="form-control form-control-lg" value="<?php echo htmlspecialchars($password ?? ''); ?>" required />
